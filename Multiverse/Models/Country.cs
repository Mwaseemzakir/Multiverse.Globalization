...
public sealed class Country
{
    ...
    public static bool IsValidNumericCode(string code)
    {
        ...
        return NumericCodeMap.ContainsKey(code.ToUpperInvariant());
    }
    ...
    public static Country? ParseCountry(string code)
    {
        ...
        {
            2 => GetCountryByAlpha2CodeOrDefault(code),
            3 when code.All(char.IsDigit) => GetCountryByNumericCodeOrDefault(code),
            3 => GetCountryByAlpha3CodeOrDefault(code),
            _ => default
        };
    }
