...
public static class LanguageHelper
{
    ...
    public static readonly Dictionary<string, Language> Alpha2CodeMap = new(StringComparer.OrdinalIgnoreCase);
    public static readonly Dictionary<string, Language> Alpha3CodeMap = new(StringComparer.OrdinalIgnoreCase);
    public static readonly Dictionary<string, Language> NameMap = new(StringComparer.OrdinalIgnoreCase);
    ...
    static LanguageHelper()
    {
        ...
        foreach (var language in languages.Where(l => !string.IsNullOrEmpty(l.Alpha2Code)))
        {
            Alpha2CodeMap[language.Alpha2Code] = language;
        }

        foreach (var language in languages.Where(l => !string.IsNullOrEmpty(l.Alpha3Code)))
        {
            Alpha3CodeMap[language.Alpha3Code] = language;
        }

        foreach (var language in languages.Where(l => !string.IsNullOrEmpty(l.Name)))
        {
            NameMap[language.Name] = language;
        }
    }
